...
redraw_all:
redraw: mcall	12,1
	mcall	0,<100,580>,<100,350>,0x33ffffff,,title
...
open_file:
  ...
  @@:	bts	ax,8
	mov	[flags],ax
	jmp	redraw_all
.1:	mcall	4,130*65536+110,0x80CC0000,error_open_file_string
	jmp	still
...
save_file:			;сохраняем файл
  ...
  @@:	mcall	70,func_70
	...
	jz	redraw_all
	mcall	4,130*65536+110,0x80CC0000,error_save_file_string
	jmp	still
...
get_InfoBlock:
	...
	push	ecx edx
	xor	ecx,ecx
.1:	in	al,dx		;Проверить готовность
   ...
   @@:	out	dx,al
	...
	pop	bx
	xor	cx,cx
.2:	in	al,dx		;Проверить готовность
	dec	cx
	jz	.error
	bt	ax,6
	jnc	.2
...
show_ControlBlock:
	...
	mcall	,<50,30>,<105,15>,9,
	mcall	,<90,30>,,10,
	mcall	,<50,30>,<125,15>,11,
	mcall	,<90,30>,,12,
	mcall	4,<4,110>,0x80000000,edbx_text1
	mcall	,<7,64>,,smrt_text1
	mcall	,<4,130>,,edbx_text2
;ret
show_TestBlock:
ret
...
title db 'Hard Disk Drive INFOrmer v0.11',0
...
error_open_file_string db 'Not found!',0
error_save_file_string db 'Not saved!',0
